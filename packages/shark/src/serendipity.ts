// MIT Licensed Serendipity Sunset v1 theme
// Only modified to remove italics and background
// https://github.com/Serendipity-Theme/old-serendipity/blob/69b82be49edbf4c76b2f4f990e37ec23efb05ef8/themes/serendipity-dark-italics.json
// https://github.com/Serendipity-Theme/old-serendipity/blob/69b82be49edbf4c76b2f4f990e37ec23efb05ef8/LICENSE
...
export const serendipity = {
	...
	colors: {
		...
		'textBlockQuote.background': '#1e2431',
		'textLink.foreground': '#F06897',
		'textLink.activeForeground': '#F06897',
		'textPreformat.foreground': '#f6f6f6',
		'button.background': '#F06897',
		'button.foreground': '#191f28',
		'button.hoverBackground': '#fac761',
		'dropdown.background': '#1e2431',
		...
		'inputValidation.errorBackground': '#191f28',
		'inputValidation.errorBorder': '#ff3333',
		'inputValidation.infoBackground': '#191f28',
		'inputValidation.infoBorder': '#78a9ff',
		'inputValidation.warningBackground': '#191f28',
		...
		'listFilterWidget.background': '#1e2431',
		...
		'titleBar.activeBackground': '#191f28',
		'titleBar.activeForeground': '#f6f6f6',
		'titleBar.inactiveBackground': '#191f28',
		'titleBar.inactiveForeground': '#8c94a3',
		'titleBar.border': '#22272e',
		'extensionButton.prominentForeground': '#191f28',
		...
		'debugToolBar.background': '#1e2431',
		'walkThrough.embeddedEditorBackground': '#1e2431',
	...
	tokenColors: [
		...
		{
			name: 'Number',
			scope: ['constant.numeric', 'string.quoted.single'],
			settings: {
				foreground: '#F06897',
			},
		},
		...
		{
			name: 'Operators',
			scope: ['keyword.operator', 'string.quoted.single'],
			settings: {
				foreground: '#f29e74',
			},
		},
