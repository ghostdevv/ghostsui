    ...
    <main role="main">
        <section id="text">
            ...
            <article id="text__paragraphs">
                ...
                <div>
                    <p>
                        A paragraph (from the Greek paragraphos, “to write
                        beside” or “written beside”) is a self-contained unit of
                        a discourse in writing dealing with a particular point
                        or idea. A paragraph consists of one or more sentences.
                ...
                <div>
                    <blockquote>
                        <p>
                            ...
                            extract) is a quotation in a written document, that
                            is set off from the main text as a paragraph, or
                            block of text.
                        </p>
                        <p>
                            It is typically distinguished visually using
                            indentation and a different typeface or smaller size
                            quotation. It may or may not include a citation,
            ...
            <article id="text__code">
                ...
                <div>
                    ...
                    <p>
                        ...
                        <samp
                            >This is sample output from a computer program.</samp
                        >
                    </p>
...
p q r s t u v w x y z | ~ </pre>
                ...
                <div>
                    ...
                    <p>
                        The time element: <time
                            datetime="2013-04-06T12:32+00:00">2 weeks ago</time
                        >
                    </p>
                </div>
                <footer><p><a href="#top">[Top]</a></p></footer>
            ...
            <article id="text__comments">
                ...
                <div>
                    ...
                    <p>
                        There is a comment spanning multiple tags and lines
                        below here.
                    </p>
        ...
        <section id="embedded">
            ...
            <article id="embedded__iframe">
                ...
                <div><iframe src="index.html" height="300" /></div>
                <footer><p><a href="#top">[Top]</a></p></footer>
            </article>
        </section>
        <section id="forms">
    ...
    <footer role="contentinfo">
        <p>
            <a href="http://github.com/cbracco/html5-test-page">HTML 5 test page</a> by <a href="http://twitter.com/cbracco">@cbracco</a>
        </p>

        <p>
            <a href="https://github.com/ghostdevv/ghostsui">ghostsui</a> by <a href="https://twiiter.com">GHOST</a>
        </p>
    </footer>
</div>
